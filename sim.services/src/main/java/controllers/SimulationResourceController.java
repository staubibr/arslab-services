...
import services.SimulationResourceService;
...
public class SimulationResourceController {
	...
	public ResponseEntity<String> getSimulation(@PathVariable String username, @PathVariable String servicetype,
			@PathVariable String framework) throws IOException {
		SimulationResourceService service = new SimulationResourceService();
	...
	public String startSimulation(@PathVariable String username, @PathVariable String servicetype,
	...
	public String addMessage(@PathVariable String username, @PathVariable String servicetype,
			@PathVariable String framework, @PathVariable String oldPassword, @RequestBody String accountProperties)
			throws IOException {
		SimulationResourceService service = new SimulationResourceService();
	...
	public String stopSimulation(@PathVariable String username, @PathVariable String servicetype,
			@PathVariable String framework, @PathVariable String oldPassword) throws IOException {
