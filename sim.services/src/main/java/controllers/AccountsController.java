...
public class AccountsController {
	...
	public String createAccount(@PathVariable String username, @RequestBody String accountProperties)
			throws IOException {
	...
	public String updateAccount(@PathVariable String username, @PathVariable String oldPassword,
