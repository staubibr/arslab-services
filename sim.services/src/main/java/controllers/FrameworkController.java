...
public class FrameworkController {
	...
	public ResponseEntity<String> getFramework(@PathVariable String username, @PathVariable String servicetype,
	...
	public String addFramework(@PathVariable String username, @PathVariable String servicetype,
			@PathVariable String framework, @PathVariable String zdirvar, @PathVariable String oldPassword,
			@RequestPart(value = "file", required = true) MultipartFile file,
			@RequestPart(value = "json", required = true) String configframework) throws IOException {
		FrameworkService service = new FrameworkService();
	...
	public String deleteFramework(@PathVariable String username, @PathVariable String servicetype,
